    ...
    void Start()
    {
        ...
        for (int row = 0; row < grid.GetLength(0); row++)
        {
            for (int column = 0; column < grid.GetLength(1); column++)
            {
                ...
                GameObject pieceGameObject = Instantiate(piecePrefab, newPiece.GetPosition(), Quaternion.identity);
                ...
                if (theNumber > 30 && theNumber < 45) // 30 < x < 45, 31-44
                {
                    ...
                    var gameObjectRenderer = pieceGameObject.GetComponent<Renderer>();
                  ...
                  //  gameObject.GetComponentInChildren<Text>().text = "Orange";
                }
                else if (theNumber >= 45 && theNumber < 60) // 45 <= x < 60, 45-59
                {
                   ...
                   // gameObject.GetComponentInChildren<Text>().text = "Blue";
                }
                else if (theNumber >= 60 && theNumber < 85)
                {
                  ...
                  //  gameObject.GetComponentInChildren<Text>().text = "Red";
                }
                else if (theNumber >= 85 && theNumber < 101)
                {
                  ...
                  //  gameObject.GetComponentInChildren<Text>().text = "Green";
                }
